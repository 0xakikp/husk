...
const BUILTIN: AppearancePreset[] = [
  ...
  },
  {
    id: "focus",
    name: "Focus",
    description: "nothing between you and the text — effects off, wallpaper off",
    prefs: {
  ...
  },
  {
    id: "neon",
    name: "Neon",
    description: "high contrast, glowing edges, gridded gaps",
    prefs: {
      accentColor: "#00e5ff",
      animationsEnabled: true,
      frostedGlass: true,
