...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ai_cli::gemini_cli_available,
            ai_cli::gemini_cli_start,
            ai_cli::gemini_cli_stop,
            ai_cli::kimi_cli_available,
            ...
            fs::read_dir_scoped,
            fs::read_file_scoped,
            fs::write_file_scoped,
            fs::write_new_file_scoped,
            fs::delete_file_scoped,
            fs::create_dir_scoped,
            ...
            remote::ssh_read_dir,
            remote::ssh_read_dir_scoped,
            remote::ssh_read_file,
            remote::ssh_read_file_scoped,
            remote::ssh_write_file,
            remote::ssh_write_file_scoped,
            remote::ssh_create_file,
            remote::ssh_create_file_scoped,
            remote::ssh_delete_file_scoped,
            remote::ssh_create_dir,
            remote::ssh_copy_path,
            ...
            timeline::workflow_state_load,
            timeline::workflow_state_save,
