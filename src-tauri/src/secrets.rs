...
//!   silently fails on systems without gnome-keyring/kwallet. The file
//!   backend with user-only permissions provides equivalent isolation for
//!   an app shipped via AppImage/deb/rpm.
//!
...
/// Batch read — a single IPC roundtrip for the cold-boot key fan-out.
#[tauri::command]
